...
class SimpleAgentFactory
{
    ...
    public function create(array $contextManagers): AgentRunner
    {
        ...
        $codingAgent = new Agent(
            ...
            contextManager: $contextManagers['simple_agent']->setSystemMessage(new SystemMessage($this->loadSystemPrompt($systemPromptsDir . 'examples/simple_agent.txt'))),
            agentName: 'Simple Agent',
            agentId: 'simple_agent',
            model: '',
            tools: [],
            mcps: McpClient::fromJsonConfig($_ENV['AGENT_CONFIG_DIR'] . 'examples/simple_agent.json'),
